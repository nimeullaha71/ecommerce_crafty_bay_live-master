...
import 'package:ecommerce_crafty_bay_live/features/cart/data/models/cart_item_model.dart';
...
class CartListController extends GetxController{
  ...
  Future<bool> getCartItemList()async{
    ...
    _inProgress = true;
    update();
    NetworkResponse response = await Get.find<NetworkClient>().getRequest(Urls.getCartItemListUrl);
